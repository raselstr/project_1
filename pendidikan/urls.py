...
urlpatterns = [
    ...
    path("realisasi/simpan/<int:pk>/", view_realisasi.simpan, name="realisasi_pendidikan_simpan"),
    path("realisasi/sp2d/<int:pk>/", view_realisasi.sp2d, name="realisasi_pendidikan_sp2d"),
    ...
    path("realisasisisa/simpan/<int:pk>/", view_realisasisisa.simpan, name="realisasi_pendidikan_simpansisa"),
    path("realisasisisa/sp2d/<int:pk>/", view_realisasisisa.sp2d, name="realisasi_pendidikan_sp2dsisa"),
    ...
    path("rencana/pdf/", view_rencana.cetak, name="rencana_pendidikan_cetak"),
    ...
    path("rencanasisa/cetak/", view_rencanasisa.cetak, name="rencana_pendidikansisa_cetak"),
]