...
class Rencanapu(models.Model):
    ...
    rencana_kegiatan = models.ForeignKey(DausgpuSub, verbose_name='Sub Kegiatan DAU SG', on_delete=models.CASCADE)
...
class Rencanapuposting(models.Model):
    ...
    posting_subkegiatan = models.ForeignKey(DausgpuSub, verbose_name='Sub Kegiatan DAU SG', on_delete=models.CASCADE)
