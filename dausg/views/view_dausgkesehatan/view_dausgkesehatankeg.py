...
from ...resources import DausgkesehatanKegResource
...
resource = DausgkesehatanKegResource
...
def export(request):
    ...
    response['Content-Disposition'] = 'attachment; filename="DAU SG Kesehatan Kegiatan.xlsx"'
    return response
